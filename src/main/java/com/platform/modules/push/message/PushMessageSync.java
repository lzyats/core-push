...
public class PushMessageSync extends PushMessageBase {

    public PushMessageSync(PushFrom pushFrom, PushSync pushSync, PushMsgTypeEnum msgType, String content) {
        ...
        PushMsgData data = new PushMsgData(pushSync)
                ...
                .setChatTalk(pushSync.getChatTalk())
    ...
    class PushMsgData {
        ...
        public PushMsgData(PushSync pushSync) {
            this.chatId = NumberUtil.toStr(pushSync.getUserId());
